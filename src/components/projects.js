      ...
      <div className="container text-center" style={{ marginTop: '5%' }}>
        <div className="row">
          <div className="col-md-3">
            <div className="card " style={{ border: '3px solid #9370db', borderRadius: '20px', marginBottom: '20px' }}>
              ...
              <div className="card-body">
                <h5 className="card-title">Form dark/light theme</h5>
                <p className="card-text"></p>
                <a href="#" className="btn btn-primary" style={{ backgroundColor: '#9370db', border: '2px solid #9370db', margin: '7px'}}>Repository</a>
                <a href="#" className="btn btn-primary" style={{ backgroundColor: '#696969', border: '2px solid #696969' }}>Deploy</a>
              </div>
